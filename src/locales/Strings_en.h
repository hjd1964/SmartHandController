...
// ------------------- SmartController.h -----------------------
#define L_WIFI_SELECT "SHC, Connection:"
...
#define L_CMD_NOTOK_1 "LX200 Command"
#define L_CMD_NOTOK_2 "has failed!"
#define L_CMD_SETVF_1 "Set Value"
#define L_CMD_SETVF_2 "has failed!"
#define L_CMD_GETVF_1 "Get Value"
#define L_CMD_GETVF_2 "has failed!"
#define L_CMD_SETTG_1 "Set Target"
#define L_CMD_SETTG_2 "has failed!"
#define L_CMD_OBJSE_1 "No Object"
#define L_CMD_OBJSE_2 "Selected!"
#define L_CMD_TGHOR_1 "Target is"
#define L_CMD_TGHOR_2 "Below Horizon!"
#define L_CMD_TGOVH_1 "Target is"
#define L_CMD_TGOVH_2 "Above Limit!"
#define L_CMD_STNBF_1 "Telescope"
#define L_CMD_STNBF_2 "in standby!"
#define L_CMD_PARKF_1 "Telescope"
#define L_CMD_PARKF_2 "is Parked!"
#define L_CMD_GOGOF_1 "Goto already"
#define L_CMD_GOGOF_2 "in progress!"
#define L_CMD_LIMTF_1 "Target"
#define L_CMD_LIMTF_2 "outside lmts!"
#define L_CMD_HARDF_1 "Telescope"
#define L_CMD_HARDF_2 "h/w fault!"
#define L_CMD_GOMOF_1 "Telescope"
#define L_CMD_GOMOF_2 "in motion!"
#define L_CMD_UNSPF_1 "Goto unknown"
#define L_CMD_UNSPF_2 "error!"
#define L_CMD_ERROR   "Error"
#define L_CMD_ISAOK_1 "LX200 Command"
#define L_CMD_ISAOK_2 "Done!"
#define L_CMD_SETOK_1 "Value"
#define L_CMD_SETOK_2 "Set!"
#define L_CMD_GETOK_1 "Value"
#define L_CMD_GETOK_2 "Get!"
#define L_CMD_SNCOK_1 "Telescope"
#define L_CMD_SNCOK_2 "Synced!"
#define L_CMD_GOTOK_1 "Slew to"
#define L_CMD_GOTOK_2 "Target"
