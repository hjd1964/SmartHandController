...
#if defined(ESP32) || defined(ARDUINO_TEENSY40) || defined(ARDUINO_TEENSY41)
...
//#include "src/catalogs/data/carbon.h"          // Carbon Variable Stars, S&T list of 101 stars
  ...
  #include "src/catalogs/data/stt_select_c.h"    // Struve STT catalog, limited to 114 double stars brighter than Magnitude 8.5
  #include "src/catalogs/data/gcvs_select_c.h"   // General Catalog of Variable Stars, limited to 621 stars brighter than Magnitude 10 w/ a difference in magnitude of >1
//#include "src/catalogs/data/carbon.h"          // Carbon Variable Stars, S&T list of 101 stars
  #include "src/catalogs/data/messier_c.h"       // Charles Messier's famous catalog of 109 DSO's
  #include "src/catalogs/data/caldwell_c.h"      // The Caldwell (supplement) catalog of 109 DSO's
  #include "src/catalogs/data/herschel_c.h"      // Herschel's "400 best of the NGC" catalog
  #include "src/catalogs/data/collinder_vc.h"    // The Collinder catalog of 471 open clusters
  #include "src/catalogs/data/ngc_select_c.h"    // The New General Catalog of 2367 DSO's, limited to Magnitude 16 AND with surface brightness >= 22.5m/arc-sec^2
