...
It can communicate with OnStep over the ST4 guiding port (which automatically reconfigures itself for synchronous serial communications when it detects an SHC,) a Serial port, or over WiFi/Bluetooth instead if running on an ESP32 (recommended.)
